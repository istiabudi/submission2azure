<html>
 ...
 <meta charset="utf-8">
    ...
    <title>Universitas Mulia Smart</title>
 ...
 <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
    ...
    <div class="starter-template"> <br><br><br>
        <h1>Universitas Mulia Smart</h1>
        <p class="lead">Isikan dengan lengkap dari <b>Nama, NIM, TNBK, Foto Diri </b> anda.<br> Kemudian Click <b>Submit Data Kendaraan</b> untuk Registrasi Kendaraan anda.</p> <br>
        ...
        <div class="form-group">
            <label for="NIK">Tanda Nomor Induk Keluarga (TNIK): </label>
        ...
        <!-- <div class="form-group" action="index.php" method="post" enctype="multipart/form-data">
            <label for="upload">Unggah Foto Anda : </label> <br>
 ...
 <?php
    ...
    if (isset($_POST['submit'])) {
        try {
            ...
            $date = date("Y-m-d");
            // Insert data
            $sql_insert = "INSERT INTO Registration (nama, nim, nik, date) 
                        VALUES (?,?,?,?)";
